...
class Iface(object):
    ...
    def login(self, uri, apiKey, apiSecret):
        """
        Parameters:
         - uri
         - apiKey
...
class Client(Iface):
    ...
    def login(self, uri, apiKey, apiSecret):
        ...
        """
        self.send_login(uri, apiKey, apiSecret)
        self.recv_login()

    def send_login(self, uri, apiKey, apiSecret):
    ...
    def createStandardCluster(self, hazelcastVersion, isTlsEnabled):
        ...
        """
        self.send_createStandardCluster(hazelcastVersion, isTlsEnabled)
        return self.recv_createStandardCluster()

    def send_createStandardCluster(self, hazelcastVersion, isTlsEnabled):
        self._oprot.writeMessageBegin('createStandardCluster', TMessageType.CALL, self._seqid)
        args = createStandardCluster_args()
    ...
    def recv_createStandardCluster(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = createStandardCluster_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "createStandardCluster failed: unknown result")
    ...
    def createEnterpriseCluster(self, cloudProvider, hazelcastVersion, isTlsEnabled):
        ...
        """
        self.send_createEnterpriseCluster(cloudProvider, hazelcastVersion, isTlsEnabled)
        return self.recv_createEnterpriseCluster()

    def send_createEnterpriseCluster(self, cloudProvider, hazelcastVersion, isTlsEnabled):
        self._oprot.writeMessageBegin('createEnterpriseCluster', TMessageType.CALL, self._seqid)
        args = createEnterpriseCluster_args()
    ...
    def recv_createEnterpriseCluster(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = createEnterpriseCluster_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "createEnterpriseCluster failed: unknown result")
    ...
    def scaleUpDownStandardCluster(self, id, scaleNumber):
        ...
        """
        self.send_scaleUpDownStandardCluster(id, scaleNumber)
        return self.recv_scaleUpDownStandardCluster()

    def send_scaleUpDownStandardCluster(self, id, scaleNumber):
        self._oprot.writeMessageBegin('scaleUpDownStandardCluster', TMessageType.CALL, self._seqid)
        args = scaleUpDownStandardCluster_args()
        args.id = id
    ...
    def recv_scaleUpDownStandardCluster(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = scaleUpDownStandardCluster_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "scaleUpDownStandardCluster failed: unknown result")
    ...
    def getCluster(self, id):
        ...
        """
        self.send_getCluster(id)
        return self.recv_getCluster()

    def send_getCluster(self, id):
        self._oprot.writeMessageBegin('getCluster', TMessageType.CALL, self._seqid)
        args = getCluster_args()
        args.id = id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getCluster(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getCluster_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getCluster failed: unknown result")
    ...
    def stopCluster(self, id):
        ...
        """
        self.send_stopCluster(id)
        return self.recv_stopCluster()

    def send_stopCluster(self, id):
        self._oprot.writeMessageBegin('stopCluster', TMessageType.CALL, self._seqid)
        args = stopCluster_args()
        args.id = id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_stopCluster(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = stopCluster_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "stopCluster failed: unknown result")
    ...
    def resumeCluster(self, id):
        ...
        """
        self.send_resumeCluster(id)
        return self.recv_resumeCluster()

    def send_resumeCluster(self, id):
        self._oprot.writeMessageBegin('resumeCluster', TMessageType.CALL, self._seqid)
        args = resumeCluster_args()
        args.id = id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_resumeCluster(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = resumeCluster_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "resumeCluster failed: unknown result")
    ...
    def deleteCluster(self, id):
        ...
        """
        self.send_deleteCluster(id)
        return self.recv_deleteCluster()

    def send_deleteCluster(self, id):
        self._oprot.writeMessageBegin('deleteCluster', TMessageType.CALL, self._seqid)
        args = deleteCluster_args()
        args.id = id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_deleteCluster(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = deleteCluster_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "deleteCluster failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["createStandardCluster"] = Processor.process_createStandardCluster
        self._processMap["createEnterpriseCluster"] = Processor.process_createEnterpriseCluster
        self._processMap["scaleUpDownStandardCluster"] = Processor.process_scaleUpDownStandardCluster
        self._processMap["getCluster"] = Processor.process_getCluster
        self._processMap["stopCluster"] = Processor.process_stopCluster
        self._processMap["resumeCluster"] = Processor.process_resumeCluster
        self._processMap["deleteCluster"] = Processor.process_deleteCluster
    ...
    def process_login(self, seqid, iprot, oprot):
        ...
        result = login_result()
        try:
            self._handler.login(args.uri, args.apiKey, args.apiSecret)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_createStandardCluster(self, seqid, iprot, oprot):
        args = createStandardCluster_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = createStandardCluster_result()
        try:
            result.success = self._handler.createStandardCluster(args.hazelcastVersion, args.isTlsEnabled)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("createStandardCluster", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_createEnterpriseCluster(self, seqid, iprot, oprot):
        args = createEnterpriseCluster_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = createEnterpriseCluster_result()
        try:
            result.success = self._handler.createEnterpriseCluster(args.cloudProvider, args.hazelcastVersion, args.isTlsEnabled)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("createEnterpriseCluster", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_scaleUpDownStandardCluster(self, seqid, iprot, oprot):
        args = scaleUpDownStandardCluster_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = scaleUpDownStandardCluster_result()
        try:
            result.success = self._handler.scaleUpDownStandardCluster(args.id, args.scaleNumber)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("scaleUpDownStandardCluster", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_getCluster(self, seqid, iprot, oprot):
        args = getCluster_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getCluster_result()
        try:
            result.success = self._handler.getCluster(args.id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getCluster", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_stopCluster(self, seqid, iprot, oprot):
        args = stopCluster_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = stopCluster_result()
        try:
            result.success = self._handler.stopCluster(args.id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("stopCluster", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_resumeCluster(self, seqid, iprot, oprot):
        args = resumeCluster_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = resumeCluster_result()
        try:
            result.success = self._handler.resumeCluster(args.id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("resumeCluster", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_deleteCluster(self, seqid, iprot, oprot):
        args = deleteCluster_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = deleteCluster_result()
        try:
            result.success = self._handler.deleteCluster(args.id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("deleteCluster", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class createStandardCluster_args(object):
    """
    Attributes:
     - hazelcastVersion
     - isTlsEnabled
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('createStandardCluster_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createStandardCluster_args)
createStandardCluster_args.thrift_spec = (
    None,  # 0
...
class createStandardCluster_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('createStandardCluster_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createStandardCluster_result)
createStandardCluster_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CloudCluster, None], None, ),  # 0
)


class createEnterpriseCluster_args(object):
    """
    Attributes:
     - cloudProvider
     - hazelcastVersion
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('createEnterpriseCluster_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createEnterpriseCluster_args)
createEnterpriseCluster_args.thrift_spec = (
    None,  # 0
...
class createEnterpriseCluster_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('createEnterpriseCluster_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createEnterpriseCluster_result)
createEnterpriseCluster_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CloudCluster, None], None, ),  # 0
)


class scaleUpDownStandardCluster_args(object):
    """
    Attributes:
     - id
     - scaleNumber
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('scaleUpDownStandardCluster_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(scaleUpDownStandardCluster_args)
scaleUpDownStandardCluster_args.thrift_spec = (
    None,  # 0
...
class scaleUpDownStandardCluster_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('scaleUpDownStandardCluster_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(scaleUpDownStandardCluster_result)
scaleUpDownStandardCluster_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
)


class getCluster_args(object):
    """
    Attributes:
     - id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getCluster_args')
        if self.id is not None:
            oprot.writeFieldBegin('id', TType.STRING, 1)
            oprot.writeString(self.id.encode('utf-8') if sys.version_info[0] == 2 else self.id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getCluster_args)
getCluster_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'id', 'UTF8', None, ),  # 1
)


class getCluster_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getCluster_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getCluster_result)
getCluster_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CloudCluster, None], None, ),  # 0
)


class stopCluster_args(object):
    """
    Attributes:
     - id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('stopCluster_args')
        if self.id is not None:
            oprot.writeFieldBegin('id', TType.STRING, 1)
            oprot.writeString(self.id.encode('utf-8') if sys.version_info[0] == 2 else self.id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(stopCluster_args)
stopCluster_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'id', 'UTF8', None, ),  # 1
)


class stopCluster_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('stopCluster_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(stopCluster_result)
stopCluster_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CloudCluster, None], None, ),  # 0
)


class resumeCluster_args(object):
    """
    Attributes:
     - id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('resumeCluster_args')
        if self.id is not None:
            oprot.writeFieldBegin('id', TType.STRING, 1)
            oprot.writeString(self.id.encode('utf-8') if sys.version_info[0] == 2 else self.id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(resumeCluster_args)
resumeCluster_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'id', 'UTF8', None, ),  # 1
)


class resumeCluster_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('resumeCluster_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(resumeCluster_result)
resumeCluster_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CloudCluster, None], None, ),  # 0
)


class deleteCluster_args(object):
    """
    Attributes:
     - id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteCluster_args')
        if self.id is not None:
            oprot.writeFieldBegin('id', TType.STRING, 1)
            oprot.writeString(self.id.encode('utf-8') if sys.version_info[0] == 2 else self.id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteCluster_args)
deleteCluster_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'id', 'UTF8', None, ),  # 1
)


class deleteCluster_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteCluster_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteCluster_result)
deleteCluster_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
)
